...
*/
        ...
        'panel' => [
            ...
            'type' => 'info',
            'before' => Html::a('<i class="glyphicon glyphicon-plus"></i> 新建', ['create'], ['class' => 'btn btn-success']),
            'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> 复原列表', ['index'], ['class' => 'btn btn-info']),
            'showFooter' => false
        ],
    ]); Pjax::end(); ?>
<?php else: ?>
