...
class BaseController extends Controller
{
    ...
    /**
     * 当前登录的用户
     * @var $user \common\models\Base_user
     */
    public $user = null;
    ...
    public function init()
    {
        ...
        $usertoken = $this->getParam('token');

        if (!$usertoken) {
            $usertoken = $this->request->getHeaders()->get('X-Access-Token');
        }
