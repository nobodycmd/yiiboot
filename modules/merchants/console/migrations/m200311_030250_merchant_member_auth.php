...
class m200311_030250_merchant_member_auth extends Migration
{
    public function up()
    {
        /* 创建表 */
        $this->createTable('{{%merchant_member_auth}}', [
            ...
            'PRIMARY KEY (`id`)'
        ], "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='用户_第三方登录'");
        
        /* 索引设置 */
        $this->createIndex('oauth_client','{{%merchant_member_auth}}','oauth_client, oauth_client_user_id',0);
        $this->createIndex('member_id','{{%merchant_member_auth}}','member_id',0);
    ...
    {
        /* 删除表 */
        $this->dropTable('{{%merchant_member_auth}}');
    }
}
