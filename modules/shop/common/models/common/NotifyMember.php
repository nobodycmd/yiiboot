...
namespace modules\shop\common\models\common;
...
class NotifyMember extends \common\models\base\BaseModel
{
    ...
    {
        return '{{%addon_shop_base_notify_member}}';
    }
    ...
    {
        return [
            [['member_id', 'merchant_id', 'notify_id', 'is_read', 'type', 'status', 'created_at', 'updated_at'], 'integer'],
        ];
    }
