...
class Module extends \modules\Module
{
    ...
    const CORE_MODULE_PATH = '@modules/wechat/modules';
    /**
     * 扩展模块存放路径
     */
    //const ADDON_MODULE_PATH = '@app/modules/wechat/modules';
    const ADDON_MODULE_PATH = '@modules/wechat/modules';
    /**
     * 模块数据缓存
     */
    ...
    /**
     * 消息的基本视图
     * @see \modules\wechat\components\BaseController::message()
     * @var string
     */
     ...
     * @var string
     */
    public $moduleModelClass = 'modules\wechat\models\Module';
    /**
     * 默认微信请求接收路由
     * @var string
     */
    ...
    /**
     * 移动页面公众号查询参数名
     * @see \modules\wechat\components\MobileController::getWechat();
     * @var string
     */
     ...
     *     [...]
     *     'wechat' => [
     *          'class' => 'modules\wechat\generators\wechat\Generators'
     *     ],
     *     [...]
     *     ]
     * ```
